...
const main = async () => {
    ...
    // await tempPickle.transfer(CelerClient.address,1000000);
    ...
    // }
    // );
    // console.log(await CelerClient.underlying());

    // console.log("after :", await tempPickle.balanceOf(deployer.address));
    // console.log(await CelerClient.senderBalance());
};
